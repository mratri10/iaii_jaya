...
const RegisterMember = ({
  ...
  const [pria, setPria] = React.useState(true);
  ...
  const [tanggal, setTanggal] = React.useState(0);
  const tgl = () => {
    const tglInput = [];
    for (let i = 1; i < 32; i++) {
      tglInput.push(i);
            ...
            <GridItem xs={12} sm={12} md={12}>
              <Card className={classes[cardAnimaton]}>
                <form className={classes.form}>
                  <h3 className={classes.title}>Data Member</h3>
                  <CardBody>
                    ...
                    <div className={classes.baris}>
                      <div>
                        ...
                        <div style={{ display: "flex" }}>
                          <Button
                            ...
                            fullWidth
                            color={pria ? "info" : "transparent"}
                            size="sm"
                            onClick={() => setPria(true)}
                          >
                            Laki - Laki
                          </Button>
                          <div className={classes.batas} />
                      ...
                      <div>
                        ...
                        <div className={classes.barisTanggal}>
                          <CustomDropdown
                            dropup
                            buttonText={tanggal === 0 ? "Tanggal" : tanggal}
                            dropdownHeader="Tanggal"
                            buttonProps={{
                              round: true,
                              className: classes.navLink,
                              color: "info",
                            }}
                            dropdownList={tgl().map((items) => {
                              return (
                                <div
                          ...
                          <CustomDropdown
                            dropup
                            buttonText={bulan === 0 ? "Bulan" : bulan}
                            dropdownHeader="Bulan"
                            buttonProps={{
                              round: true,
                              className: classes.navLink,
                              color: "info",
                            }}
                            dropdownList={bln().map((items) => {
                              return (
                                <div
                                  className={classes.clickLokasi}
                                  onClick={() => {
                          ...
                          <CustomDropdown
                            dropup
                            buttonText={tahun === 0 ? "Tahun" : tahun}
                            dropdownHeader="Tahun"
                            buttonProps={{
                              round: true,
                              className: classes.navLink,
                              color: "info",
                          ...
                          <div className={classes.batas} />
                          <CustomInput
                            labelText="Kota/Kabupaten Lahir"
                            id="cityLahir"
                            formControlProps={{
                              fullWidth: true,
                            }}
                  ...
                  <h3 className={classes.title}>Berkas Member</h3>
                  <CardBody>
                    <label>KTP</label>
                    <div
...
export default connect(mapsPropsToState, mapsDispatchToProp)(RegisterMember);
